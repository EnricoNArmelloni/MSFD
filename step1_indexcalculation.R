...
#### Settings
setwd("~/CNR/MSFD/data/MFSD_ANALISI MEDITS SOLEMON GSA 17/Data") ### folder where basic input data are stored
####---- specify your strata selection: if no selection needed, activate row 44, otherwise type in row 45 your selection
selection=NA
#selection=c("B", "C")
...
countrycode=c("ITA")# Uppercase use combine for pull together two or more countries
...
### Folder creation #####
WD=getwd()
dir_t=paste0("~/CNR/MSFD/github/release","/","GSA",gsa,sep="")
